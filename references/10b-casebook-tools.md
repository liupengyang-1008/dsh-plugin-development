...
> **文件来源**：本文件由 `10-community-casebook.md` 拆分而来。**原为**原文的**逐行搬迁**；🔴 **2026-09-15 与 09-16 因许可整改被定点改写两轮**（先清 AGPL 逐字转载 → 再把该来源整体移出引用集合），**当前已非逐行搬迁**。改动范围与理由见下方「许可警示」与 §1.2 末尾的移除清单。（其余各册 `10a` / `10c` / `10d` 仍是逐行搬迁。）
